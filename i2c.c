...
void I2C_Init(void) {
	...
	// ToDo 1.7 Uncomment all and fill gaps 0xXX.
	...
	// Set baud rate ~100kHz = BusClock / (2^MULT * SCLdivider) 
	I2C0->F  |= I2C_F_MULT(0x001);					/* MULT = 0,1,2 */
	I2C0->F  |= I2C_F_ICR(0x016);					/* SCLdivider = Table 36-28. I2C divider and hold values. Reference Manual p.622 */
